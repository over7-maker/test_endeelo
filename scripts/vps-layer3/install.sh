...
# Fortress v3.1 - VPS Layer 3 (Tor Exit VPS) Installation Script
# يتطلب: Ubuntu 20.04/22.04

set -e

echo "=== تثبيت Fortress v3.1 - VPS Layer 3 (Tor Exit) ==="
...
# سيتم إضافة peers من Layer 2 يدوياً
EOF

# تكوين Tor كـ Exit Node
cat > /etc/tor/torrc << EOF
# Fortress VPS Layer 3 - Tor Exit Configuration
...
# السماح بـ WireGuard من Layer 2
...
echo ""
echo "WireGuard Endpoint: $(curl -s ifconfig.me):51822"
echo ""
echo "ملاحظات:"
echo "1. أضف peer من Layer 2 إلى /etc/wireguard/wg0.conf"
